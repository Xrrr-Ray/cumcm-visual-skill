---
name: cumcm-editable-visual-skill
...
本 Skill 是基于开源 HTML-PPT Studio 扩展的数模国赛论文可编辑可视化增强版，不是全国大学生数学建模竞赛组委会的官方工具。它的调用名是 `$cumcm-editable-visual-skill`，可与其他名为 `$cumcm-visual-skill` 的可视化 Skill 同时安装和使用。
